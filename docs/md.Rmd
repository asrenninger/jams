...
Fitting a linear mixed effects curve, we can predict on each street segment at each our of the day. It too shows bias at certain values, notably at low values.  
