...
From here we can train a unique model on each street segment; with limited data, this will have trouble finding trends but as the dataset expands we should expect better results. 
