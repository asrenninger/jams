...
The twin challenges here are *spatial* and *spatio-temporal* modelling: for transportation planning, a model to understand flows beyond daily fluxuations is better, while other use cases might demand predictions around adjustments to the network. The hypothesis that we are testing here is that network centrality---or variious centralities---matter in the prediction of traffic congestion. 
